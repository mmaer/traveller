...
- Keep in mind that, I don't work with Typescript at daily.
- I used React context to share state and dispatch between components. At this level, I prefer rerendering everything when state is being updated instead of doing prop drilling.
- I didn't have enough time to do everything, so I create a to-do list of what can be done next.
- I forgot to initialize repo at the beginning of work. Sorry for that.

### To do list

- [ ] Write more component tests
- [ ] Implement loading and error states in components.
- [ ] Search cities by countries??
- [ ] Divide reducer into smaller files (actions, context, reducer, etc.)
